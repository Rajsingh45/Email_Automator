...
I hope this email finds you well. I am currently a third-year engineering student pursuing a B.Tech degree in Computer Engineering and.......( your content) 
.........
...
# List of recipients
recipients = [
     {"company_name": "TCS", "recipient_email": "doe.samunuel@tcs.com"},
...
def send_email(company_name, recipient_email, resume_path):
    ...
    message["Subject"] = "Inquiry Regarding Internship Opportunities"
